...
path_sims = "/home/cotil/Documents/code_julia/SBM/Experiments/Work1/EXPE1asym/Simulations"
path_estims = nothing
path_results = "/home/cotil/Documents/code_julia/SBM/Experiments/Work1/EXPE1asym"
...
keys_estimators = ["LloydL1", "LloydHuber0.05", "LloydL2"]
estimators["LloydL1"] = SBMEstimator("LloydMix", metric = "l1", max_iter = max_iter, max_time = max_time, with_ini = true)
estimators["LloydHuber0.05"] = SBMEstimator("LloydMix", metric = "Huber", Huber_const = 0.05, max_iter = max_iter, max_time = max_time, with_ini = true)
estimators["LloydL2"] = SBMEstimator("LloydMix", metric = "l2", max_iter = max_iter, max_time = max_time, with_ini = true)
...
n_labels = Parameter(3)
n_nodes = Parameter(100)
param_prob_labels = Parameter([0.0, 0.3, 0.6])
p_intra = Parameter(0.9)
p_inter = Parameter([0.1, 0.7, 0.8])
...
expe1D = ExpeParamSet(parameters, keys_parameters, estimators, keys_estimators, benchmarks, output)
...
keys_expe = ["expe1A1", "expe1A2", "expe1B1", "expe1B2", "expe1C1", "expe1C2", "expe1D"]
